...
# This module exercises the Python 2.7 specific dict-ordering serialization of
# ``json.dumps``; under Python 3 the expected ordering doesn't hold.
pytestmark = pytest.mark.skipif(sys.version_info[0] >= 3, reason="py2.7-specific contents ordering")
...
class TestDocLogItemConverter(unittest.TestCase):
    ...
    def test_to_log_item(self):
        # parse_timestamp interprets bare timestamps in the local TZ; pin to UTC.
        self.doc["_source"]["es_date"] = "2018-07-23 14:00:00 UTC"
