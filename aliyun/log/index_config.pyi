...
class IndexLineConfig(object):
    auto_key_detect: Optional[bool]
    auto_text_keys: List[str]
    def __init__(self, token_list: Optional[List[str]] = ..., case_sensitive: bool = ..., include_keys: Optional[List[str]] = ..., exclude_keys: Optional[List[str]] = ..., chinese: Optional[bool] = ..., auto_key_detect: Optional[bool] = ..., auto_key_count_limit: Optional[int] = ..., auto_text_keys: Optional[List[str]] = ...) -> None: ...
    def to_json(self) -> Any: ...
    def from_json(self, json_value: Any) -> None: ...
