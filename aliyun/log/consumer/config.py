...
PRE_ALLOCATED_BYTES = 10 * 1024 * 1024
...
class LogHubConfig(object):
    ...
    def __init__(self, endpoint, access_key_id, access_key, project, logstore,
                 ...
                 cursor_end_time=None, consumer_group_time_out=None,metric_fields_from_scheduler=None,flush_check_metric_interval=None,
                 credentials_refresher=None,
                 max_in_progressing_data_size_in_mB=0,
        ...
        :param consumer_group_time_out: group time out, at least should >= 2 * heat beat interval. default = 2 * heatbeat interval
        """
        ...
        self.consumer_group_time_out = int(max((consumer_group_time_out or self.heartbeat_interval * 2),
        ...
        self.max_in_progressing_data_size_in_mB = max_in_progressing_data_size_in_mB
