...
def copy_logstore(from_client, from_project, from_logstore, to_logstore, to_project=None, to_client=None, to_region_endpoint=None, keep_same_config_name=False):
    """
    ...
    :type keep_same_config_name: bool
    :param keep_same_config_name: use the same logtail config name as the source one
